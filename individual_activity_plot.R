output$individual_activity_plot <- renderPlot({
...
output$individual_activity_plot_render <- renderUI({
  plotOutput("individual_activity_plot", height = input$plot_height*2, width = input$plot_width)
})